...
class SLP(NeuralNetwork):
    def __init__(self,
        ...
        super(SLP, self).__init__(vocab_list)
        self.model_type = "slp"
    ...
    def create_model_name(self):
        ...
        self.model_name = f"slp{self.add_on}_{self.embedding_size}_{date_time_string}"
    ...
    def forward(self, x):
        ...
        if self.add_on == 'ro':
            ...
            self.state_dict['output'] = self.layer_dict['output'](embedding_out)
