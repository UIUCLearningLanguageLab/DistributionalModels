...
class NeuralNetwork(torch.nn.Module):
    def __init__(self, corpus, block_size, embedding_size, hidden_layer_info_list, weight_init, criterion, device=None,
            ...
            for i in range(len(self.hidden_layer_info_list)):
                if self.hidden_layer_info_list[i][0] == "linear":
                    ...
                    layer_list, \
                        type_list, \
                        size_list, \
                        previous_layer_size = self.create_gpt_layer(previous_layer_size,
